...
const voiceApi = read("apps/desktop/src/ui/services/electron-api/voice.ts");
const settingsApi = read("apps/desktop/src/ui/services/electron-api/settings.ts");
const settingsPage = read("apps/desktop/src/ui/pages/Settings/SettingsPage.tsx");
const page = read("apps/desktop/src/ui/pages/Voice/VoicePage.tsx");
const queue = read("apps/desktop/src/ui/pages/Voice/useVoiceQueue.ts");
const audioCard = read("apps/desktop/src/ui/components/audio/VoiceAudioCard.tsx");
const styles = read("apps/desktop/src/ui/styles/components.css");
const storageKeys = read("apps/desktop/src/ui/storage/keys.ts");
